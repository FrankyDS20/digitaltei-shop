            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="row">
                            ...
                            <div class="odr-box">
                                ...
                                <div class="rounded p-2 bg-light">
                                    <div class="media mb-2 border-bottom">
                                        <div class="media-body"> <a href="{{ route('detail')}}"> Lorem ipsum dolor sit amet</a>
                        ...
                        <div class="col-12 d-flex shopping-box"> <a href="{{ route('checkout')}}" class="ml-auto btn hvr-hover">Place Order</a> </div>
                    </div>
                </div>
            </div>
