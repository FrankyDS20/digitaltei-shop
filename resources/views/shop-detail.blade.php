...
<body>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <i class="fa fa-bars"></i>
                     ...
                     <a class="navbar-brand" href="{{ asset('index')}}"><img src="{{asset('images/logo.png" height="140"   class="logo" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ asset('about')}}">Nosotros</a></li>
                        <li class="dropdown active">
                            <a href="#" class="nav-link dropdown-toggle arrow" data-toggle="dropdown">Tienda</a>
                            <ul class="dropdown-menu">
								<li><a href="{{ route('shop')}}">Productos</a></li>
								<li><a href="{{ route('shop-detail')}}">Productos Detalle</a></li>
                             ...
                             <li class="nav-item"><a class="nav-link" href="{{ asset('gallery')}}">Servicios</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ asset('contact-us')}}">Contactanos</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                            ...
                            <div class="products-single fix">
                                <div class="box-img-hover">
                                    ...
                                    <div class="mask-icon">
                                        ...
                                        <a class="cart" href="#">Add to Carrito de Compras</a>
                                    </div>
                                </div>
                                <div class="why-text">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><i class="fas fa-phone-square"></i>Phone: <a href="{{ route('tel:+1-888705770">+1-888 705 770</a></p>
                                </li>
                                <li>
                                    <p><i class="fas fa-envelope"></i>Email: <a href="{{ route('mailto:contactinfo@gmail.com">contactinfo@gmail.com</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="footer-copyright">
        <p class="footer-company">All Rights Reserved. &copy; 2018 <a href="#">ThewayShop</a> Design By :
            <a href="{{ route('https://html.design/">html design</a></p>
    </div>
    <!-- End copyright  -->
